...
#SBATCH -N 1 
#SBATCH -J ExtremePointsAlongDirection
#SBATCH -o ExtremePointsAlongDirection.log
#SBATCH -e ExtremePointsAlongDirection.log
#set CC=/uufs/chpc.utah.edu/sys/installdir/gcc/5.4.0/bin/gcc
#set CXX=/uufs/chpc.utah.edu/sys/installdir/dcc/5.4.0/bin/g++

testname="ExtremePointsAlongDirection.txt"
